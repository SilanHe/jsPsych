...
jsPsych.plugins['html-submit-form'] = (function () {
  const plugin = {};

  plugin.info = {
    name: 'html-submit-form',
    description: '',
    parameters: {
      html: {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    // add submit button
    html += `<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="${trial.button_label}" disabled="disabled"></input>`;
